...
public class MatrixProcessing {
    ...
    private static void addMatrices() {
        ...
        if (canAdd(matrixA, matrixB)) {
            ...
            System.out.println("ERROR: Matrices can only be added if they have the same dimensions.");
        }
    }
    ...
    private static void multiplyMatrices() {
        ...
        if (canMultiply(matrixA, matrixB)) {
            ...
            System.out.println("ERROR: Matrices cannot be multiplied. The number of columns in the first matrix must be equal to the number of rows in the second matrix.");
        }
    }
